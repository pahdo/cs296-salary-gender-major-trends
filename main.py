...
if __name__ == '__main__':
    dumbdict = 
{'Agr & Environmental Cmc & Educ': 'ENVIRONMENTAL ENGINEERING', 'Animal Sciences': 'ANIMAL SCIENCES', 'Crop Sciences': 'PLANT SCIENCE AND AGRONOMY', 'Food Science & Human Nutrition': 'FOOD SCIENCE', 'Human Development & Family St': 'FAMILY AND CONSUMER SCIENCES', 'Intl, Resource, Consumer Econ': 'AGRICULTURAL ECONOMICS', 'Natural Resrcs & Environ Sci': 'ENVIRONMENTAL SCIENCE', 'Technical Systems Management': 'MANAGEMENT INFORMATION SYSTEMS AND STATISTICS', 'Accountancy': 'ACCOUNTING', 'Finance': 'FINANCE', 'Marketing': 'MARKETING AND MARKETING RESEARCH', 'Elementary Education': 'ELEMENTARY EDUCATION', 'Special Education': 'SPECIAL NEEDS EDUCATION', 'Aerospace Engineering': 'AEROSPACE ENGINEERING', 'Bioengineering' = 'BIOMEDICAL ENGINEERING', 'Civil Engineering': 'CIVIL ENGINEERING', 'Computer Engineering': 'COMPUTER ENGINEERING', 'Computer Science': 'COMPUTER SCIENCE', 'Electrical Engineering': 'ELECTRICAL ENGINEERING', 
